...
//    Integer addNewAccount(Account account);
    ...
    @Query(value = "INSERT INTO accounts (user_name, password, email, birthday, gender_id, location_id, job_id,role_id,avatar,expire,marital_status,money,name,phone_number,point,regis_date,message_status_id) \n" +
            ...
            "        :#{#account.gender.id}, :#{#account.location.id}, :#{#account.job.id}, 1,'https://thumbs.dreamstime.com/b/default-avatar-profile-flat-icon-vector-contact-symbol-illustration-184752213.jpg',null,'',0,'','',0,null,1)",nativeQuery = true)
